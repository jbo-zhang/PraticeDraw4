...
public class Practice14FlipboardView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //clip在前，需要根据角度自己选取裁剪的区域
//        if (degree < 90) {
//            canvas.clipRect(0, y+ bitmap.getHeight()/2, getWidth(), y + bitmap.getHeight());
//        } else {
//            canvas.clipRect(0, y, getWidth(), y + bitmap.getHeight()/2);
//        }
